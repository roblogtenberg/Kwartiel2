 ...
 *
 * @param <D>
 *            Data type that can be stored in the trie-nodes
 */
public interface Trie<D> {
	 ...
	 *            Word to add
	 * @param data
	 *            Data element that should be stored in the trie node
	 */
	...
	/**
	 * Converts the Trie structure into a graphviz string, so that it can be visualized using Graphviz See: https://en.wikipedia.org/wiki/DOT_(graph_description_language) Render online: -
